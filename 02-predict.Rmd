...
post %>% 
	...
	stat_halfeyeh() +
	geom_vline(xintercept = 150, linetype = "dashed", size = 2,
			   color = "red") +

	scale_fill_manual(values = c("gray80", "skyblue")) +
    annotate(geom = "label", x = 160, y = 0.25, label = "N(bar(x), 10)", 
    		 parse = TRUE)
...
post1 %>% 
	...
	scale_fill_manual(values = c("gray80", "skyblue")) +
	annotate(geom = "label", x = 160, y = 1.5, label = "N(bar(x), 10)", 
			 parse = TRUE)
########################################
