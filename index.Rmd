...
## ## 数据来源
<!-- - WOS  最新更新日期: 2020-05-29 -->
<!-- - InCites dataset updated  May 28, 2020. Includes Web of Science content indexed through Apr 30, 2020.  -->

<!-- - ESI Essential Science Indicators dataset updated May 14, 2020. -->
...
<!-- 三个库更新时间不同步， -->
<!-- 我最初的想法是合并呈现，然而三个库更新时间不同步，合并会带来更多的疑惑。 -->
<!-- 因此，我们搜索2020年的数据是不断更新中的，我们的分析跟不上它的脚步 -->


<!-- 为了解决数据库更新不同步，导致数据偏差的问题： -->
<!-- 我们考察 2010-2019 这十年的变化， 不去纠结2020随时更新的问题   -->
...
<!-- - 研究对象，常规报告，目的是完成工作量的，又不是报告， -->
<!-- - 统计周期，尽可能的与ESI阈值涵盖的周期一致 -->

- 统计对象：四川师范大学 (Sichuan Normal University)
- 统计周期：最近十年（比如：2010年全年 - 2020年）
